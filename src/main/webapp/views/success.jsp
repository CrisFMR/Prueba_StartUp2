...
<body>
	<section>
		<div
			...
			<div class="card w-50" style="width: 22rem;">
				<div class="card-body text-center">
					<i class="fa-solid fa-user-unlock fa-flip fa-2xl"
						style="color: #63E6BE;"></i>
					<h2 class="title fw-bold text-light lobster-regular">Usuario Registrado
						</h2>
					<hr>
					<div class="container w-75">
						<h1 class="fst-italic">Nuevo usuario registrado e sistema</h1>
						...
						<hr class="me-4">
						<article>
							<h4 class="fw-bold text-light">Te has registrado correctamente</h4>
							<hr class="me-4">
