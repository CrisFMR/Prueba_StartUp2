...
<div class="card w-50" style="width: 25rem;">
  ...
  <i class="fa-solid fa-users-rectangle fa-flip fa-2xl" style="color: #63E6BE;"></i>
   ...
   <hr class="ms-2">
        <form class="pe-3 me-1" action="${pageContext.request.contextPath}/Register" method="post">
            ...
            <button type="submit" class="btn btn-primary">Registrar</button>
             <h6 class="mt-2 ms-1">Si ya está registrado acceda <a href="${pageContext.request.contextPath}/views/login.jsp">aquí</a>.</h6>
        </form>
  </div>
</div>
</div>
