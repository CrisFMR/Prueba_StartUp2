<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="cl.praxis.models.dto.User"%>
...
<body>
	<section>
		<div
			...
			<div class="card w-50" style="width: 18rem;">
				<div class="card-body text-center">
					...
					<h2 class="title fw-bold text-light lobster-regular">Login
						Exitoso</h2>
					<hr>
					<div class="container">
						...
						<hr>
						<article>
							<h4 class="fw-bold">Bienvenido "${user.nombre}"</h4>
							<h4 class="fw-bold">Su correo es: ${user.correo}</h4>
						</article>
					</div>
				</div>
			</div>
		...
		<div
			class="row h-100 justify-content-center align-items-center py-4 mt-1">
			<div class="card w-75" style="width: 18rem;">
				<div class="card-body text-center">
					<h1>Listado de usuarios</h1>
					<div class="containerTb d-flex flex-column">
						<%
					...
					out.println("Lista de Usuarios no encontrada.");
					}
					} else {
					out.println("Acceso denegado. Sin permisos de acceso.");
					}
					%>
				</div>
			</div>
